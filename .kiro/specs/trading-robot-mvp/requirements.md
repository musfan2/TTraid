...
Торговый робот для автоматизированной работы с T-Invest API (Тинькофф Инвестиции). Приложение на Delphi 11+ (FMX) позволяет пользователю настраивать торговые заявки (ордера) на покупку/продажу активов, автоматически отслеживать текущие цены и исполнять торговую логику по расписанию. MVP-версия работает на Windows с использованием существующих Core-модулей проекта (TMyHttpClient, TTimerThread, TMySaveIniFile и др.).
